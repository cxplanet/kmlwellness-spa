...
function About() {
    return (
        <div className="about">
            ...
            <ul>
            <li>I want to save other women the uncertainty of deciding to opt in or out of HRT.</li>
            <li>I want to help them stay strong and upright for as long as possible.</li>
            <li>I want to help them improve their sleep, reduce their stress and make the lifestyle changes they want to do achieve these goals.</li>
            <li>I want to help them balance their hormones and find balance in their lives,</li>
            </ul>
            </div>
        </div>
    );
